...
namespace neatCpp {
    ...
    public:
        ...
        void train(const std::vector<long double>& inputVision, const std::vector<long double>& groundTruth);
        long double compare(const std::vector<long double>& decisions, const std::vector<long double>& groundTruth);
        /**
